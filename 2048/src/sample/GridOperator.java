...
public class GridOperator {
    ...
    private static final List<Integer> traversalX = IntStream.range(0, 5).boxed().collect(Collectors.toList());
    private static final List<Integer> traversalY = IntStream.range(0, 5).boxed().collect(Collectors.toList());
